...
exports.warga = () => {
    return [
        ...
        body('member_ktp').optional({checkFalsy: true}).bail().isLength({max: 255}).withMessage('member_ktp is required and max 255 chars'),
        ...
        body('member_card_id').optional({checkFalsy: true}).bail().isString().withMessage('member_card_id is required and should be string')
    ]
}